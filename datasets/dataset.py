...
class iNat():
    def __init__(self, input_size, root, is_train=True, data_len=None):
        ...
        train_path = os.path.join(self.root, 'train_Insecta')
        test_path = os.path.join(self.root, 'val_Insecta')
        
        train_indexes_file = open(os.path.join(self.root, 'train_indexes.txt'))
        test_indexes_file = open(os.path.join(self.root, 'val_indexes.txt'))
        train_label_file = open(os.path.join(self.root, 'train_indexes_labels.txt'))
        test_label_file = open(os.path.join(self.root, 'val_indexes_labels.txt'))      
        train_box_file = open(os.path.join(self.root, 'train_bboxes.txt'))
        test_box_file = open(os.path.join(self.root, 'val_bboxes.txt'))
